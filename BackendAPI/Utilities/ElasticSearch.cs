...
namespace BackendAPI.Utilities
{
    ...
    public static class ElasticSearch
    {
        ...
        public static async Task<string> postDataAsync(JsonDocument doc, string index)
        {
        ...
        public static async Task<string> postDataAsyncMulti(string[] docs, string index)
        {
            string postdata = "";
        ...
        public static async Task<string> getDataAsync(JsonDocument doc, string index)
        {
        ...
        public static async Task<string> deleteDataAsync(string _id, string index)
        {
            //var content = new StringContent(ElasticSearch.ToJsonString(doc),
                //Encoding.ASCII, "application/json");


            var response = await ElasticSearch.getClient().DeleteAsync("" +
                 $"{ElasticSearch.IP}/{index}/_doc/{_id}");

            var responseString = await response.Content.ReadAsStringAsync();
            return (responseString);
        }
        public static async Task<string> updateDataAsync(JsonDocument doc, string _id, string index)
        {
            var content = new StringContent(ElasticSearch.ToJsonString(doc),
            Encoding.ASCII, "application/json");


            var response = await ElasticSearch.getClient().PutAsync("" +
                 $"{ElasticSearch.IP}/{index}/_doc/{_id}", content);
